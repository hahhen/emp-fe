...
const variantsAtom = atom([])

export default function ProductInfo({ variant }) {
        ...
        <>
            {
                variant.map((item, index) => (
                    <div key={index} className='flex flex-col gap-2'>
                        ...
                        value={variants[index] !== undefined ? variants[index].value : null } type='single' className='flex gap-2 w-full'>
